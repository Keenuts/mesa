...
#define LIST_FOR_EACH(Var, List, Field) \
    for (Var = CONTAINER_OF(List.next, __typeof__(*Var), Field) ; \
         &(Var->Field) != &List; \
         Var = CONTAINER_OF(Var->Field.next, __typeof__(*Var), Field))
...
#define LIST_FRONT(Var, List, Field) \
    it = CONTAINER_OF(List.next, __typeof__(*Var), Field)

#define LIST_BACK(Var, List, Field) \
    it = CONTAINER_OF(List.prev, __typeof__(*Var), Field)
